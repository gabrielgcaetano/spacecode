                ...
                <div class="col-lg-6 contact_col magic_fade_in">
                    <div class="message_form_container">
                        ...
                        <form id="contact_form" class="contact_form" method="POST" action="{{ route('envio-emails2' )}}">
                            ...
                            Possui algum Sistem Gerencial?<br>
                            <input type="radio" name="sim" value="sim">Sim<br>
                            <input type="radio" name="nao" value="nao">Não<br>
                            Qual o segmento/atividade?<br>
                            <select name="planos">
                                <option value=""></option>
                                <option value="bebidas">Bebidas e Alimentação</option>
                                <option value="vestuario">Vestuário e Calçados</option>
                                <option value="saude">Saúde</option>
                                <option value="educacao">Educação</option>
                                <option value="pessoal">Serviços Pessoais</option>
                                <option value="especializado">Serviços Especializados</option>
                                <option value="informatica">Informática</option>
                                <option value="vendas">Vendas e Marketing</option>
                                <option value="entretenimento">Entretenimento</option>
                            </select><br>
                            Através de qual recurso pretende alcançar o cliente?<br>
                            ...
                            <select name="planos">
                                ...
                                <option value="basico">Básico WebSite</option>
